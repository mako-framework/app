...
[
	...
	'min_length'               => 'O campo %1$s deve conter ao menos %2$s caracteres.',
	'max_length'               => 'O campo %1$s deve ter menos do que %2$s caracteres.',
	'exact_length'             => 'O campo %1$s deve ter exatamente %2$s caracteres.',
	'less_than'                => 'O campo %1$s deve ser menor que %2$s.',
	'less_than_or_equal_to'    => 'O campo %1$s deve ser menor ou igual a %2$s.',
	'greater_than'             => 'O campo %1$s deve ser maior que %2$s.',
	'greater_than_or_equal_to' => 'O campo %1$s deve ser maior ou igual a %2$s.',
	'between'                  => 'O campo %1$s deve estar entre %2$s e %3$s.',
	'match'                    => 'Os campos %1$s e %2$s devem ser iguais.',
	'different'                => 'Os campos %1$s e %2$s field must be different.',
	'regex'                    => 'O valor do campo %1$s não é compativel com o formato requisitado.',
	'integer'                  => 'O campo %1$s deve conter um valor inteiro.',
	'float'                    => 'O campo %1$s deve conter um valor float.',
	'natural'                  => 'O campo %1$s deve conter um valor natural number.',
